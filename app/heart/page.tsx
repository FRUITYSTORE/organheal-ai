        ...
        <section className="ohCard">
          <div className="ohCardHeader">
            <div>
              ...
              <p className="ohCardText">
                {text(
                  "After saving your heart assessment, continue to your timeline, upload reports, or open Health Intelligence for a broader view.",
                  "بعد حفظ تقييم القلب، تابع إلى مسار التقدم، ارفع التقارير، أو افتح مركز الذكاء الصحي للحصول على رؤية أوسع."
                )}
              </p>
            </div>
          </div>
